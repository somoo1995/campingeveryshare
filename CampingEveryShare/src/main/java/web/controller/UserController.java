...
//	private ObjectMapper objectMapper;
	...
	public String mailSending(String m_email) {
		...
		String content = "campingeveryshare 홈페이지를 방문해주셔서 감사합니다." + "<br><br>" + "인증 번호는 " + num + "입니다." + "<br>"
	...
	public String joinProc(User user) {
		...
		// 회원가입 처리
		boolean joinResult = userService.join(user, selectedProfile);
	...
	@GetMapping("/view")
	public void userView(@SessionAttribute("loginId") String loginId, Model model) {
	...
	@PostMapping("/delete")
	@ResponseBody
	public String userDelete(@RequestParam("userId") String userId, @RequestParam("password") String password,
			Model model) {
