...
<!-- <h3 style="color: #1ABA00; font-weight: 600; font-size: 40px; margin-bottom: 20px;">중고장터</h3> -->
...
<div class="title">
   ...
   <div class="question">
   <a style="text-decoration: none; font-weight: bold; color: #fff;" href="/message/list?boardNo=${board.boardNo }&boardCate=3&receiverId=${board.userId}&title=${board.title}&nick=${user.userNick}&profile=1">
   1:1 문의</a>
   </div><!-- .question -->
   </div><!-- .writer_info -->
