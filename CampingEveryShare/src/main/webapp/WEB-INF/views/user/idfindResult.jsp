...
<div class="input-group has-validation">
	...
	<div class="form-floating is-invalid">
		<input type="text" class="form-control" id="userName" name="userName" onblur="nameCheck()" required>
...
<div class="input-group has-validation">
	...
	<div class="form-floating is-invalid">
		<input type="email" id="email" name="email" class="form-control" onblur="emailDupleCheck(this)" required>
