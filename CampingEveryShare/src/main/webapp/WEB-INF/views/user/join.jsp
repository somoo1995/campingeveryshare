...
<div class="col-md-6 input-group has-validation">
	...
	<div class="col-md-6 form-floating is-invalid">
		<input type="text" id="userId" name="userId" class="border border-success-subtle form-control" onblur="idDupleCheck(this)">
...
<div class="input-group has-validation">
	...
	<div class="form-floating is-invalid">
		<input type="email" id="email" name="email" class="border border-success-subtle form-control" onblur="emailDupleCheck(this)">
...
<div class="input-group has-validation">
	...
	<div class="form-floating is-invalid">
		<input type="text" class="border border-success-subtle form-control" id="userName" name="userName" onblur="nameCheck()">
...
<div class="input-group has-validation">
	...
	<div class="form-floating is-invalid">
		<input  type="text" id="userNick" name="userNick" class="border border-success-subtle form-control" onblur="nickDupleCheck(this)">
