...
<div class="container">
	...
	<div class="input-group has-validation">
		<span class="border border-success-subtle input-group-text"
			id="basic-addon1"> <svg xmlns="http://www.w3.org/2000/svg"
				width="50" height="40" fill="currentColor" class="bi bi-envelope-at"
				viewBox="0 0 16 16">
			  <path
		...
		<div class="form-floating is-invalid">
			<input type="email" class="border border-success-subtle form-control"
				name="email" id="email" oninput="emailDupleCheck(this)"
				required="required"> <label class="floatingInputGroup2">이메일*</label>
			<button id="sendEmailButton"
				class="border border-success-subtle form-control btn btn-danger"
				type="button" value="인증코드 발송" disabled="disabled">인증코드 발송</button>
		</div>
		<div class="border border-success-subtle form-control">
			<span class="position-absolute top-50 end-0 translate-middle-y"
				id="codecheck_blank" style="font-size: 15px;"></span> <label
				class="floatingInputGroup2">인증번호*</label> <input type="text"
				class="border border-success-subtle form-control" id="codeInput"
				onblur="emailVerifyCheck()" required="required" disabled="disabled">
		</div>
		<div id="emailDupleBlock" class="invalid-feedback"
			style="display: none">
