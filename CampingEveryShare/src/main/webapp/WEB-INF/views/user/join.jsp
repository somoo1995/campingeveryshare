...
<!--           <button id="sendEmailButton" type="button" class="btn btn-primary" disabled="disabled" onclick="sendEmail()">인증 코드 발송</button> -->
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid birth">
			<input  type="date" id="birth" name="birth" class="border border-success-subtle form-control">
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid birth">
			<input  type="text" id="address" name="address" class="border border-success-subtle form-control">
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid birth">
			<input  type="text" id="addressDetail" name="addressDetail" class="border border-success-subtle form-control">
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid birth">
			<input  type="number" id="phone" name="phone" class="border border-success-subtle form-control">
		    <label for="floatingInputGroup2">연락처</label>
	  	</div>
	</div>
		
	<div class="form-floating is-invalid birth">
		<button id="joinButton" type="submit" class="border-success-subtle form-control btn btn-outline-success">캠핑 시작하기</button>
	</div>
