...
<div class="col-md-6 input-group has-validation">
    <span class="border border-success-subtle input-group-text" id="basic-addon1">
        ...
        <ul>
            ...
            <li>
                <input class="form-check-input" type="radio" name="profile" id="profile" value="2" >
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                <input class="form-check-input" type="radio" name="profile" id="profile" value="3" >
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                <input class="form-check-input" type="radio" name="profile" id="profile" value="4" >
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                <input class="form-check-input" type="radio" name="profile" id="profile" value="5" >
            </li>
        </ul>
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid">
			<input type="email" id="email" name="email" class="border border-success-subtle form-control" onblur="emailDupleCheck(this)" value="${updateUser.email }" disabled>
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid">
			<input type="text" class="border border-success-subtle form-control" id="userName" name="userName" onblur="nameCheck()" value="${updateUser.userName }" disabled>
		    <label for="floatingInputGroup2">이름*</label>
	  	</div>
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid">
			<input  type="text" id="userNick" name="userNick" class="border border-success-subtle form-control" onblur="nickDupleCheck(this)" value="${updateUser.userNick }" disabled>
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid birth">
			<input  type="date" id="birth" name="birth" class="border border-success-subtle form-control" value="${updateUser.birth }" >
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid birth">
			<input  type="text" id="address" name="address" class="border border-success-subtle form-control" value="${updateUser.address }" >
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid birth">
			<input  type="text" id="addressDetail" name="addressDetail" class="border border-success-subtle form-control" value="${updateUser.addressDetail }" >
	...
	<div class="input-group has-validation">
		...
		<div class="form-floating is-invalid birth">
			<input  type="number" id="phone" name="phone" class="border border-success-subtle form-control" value="${updateUser.phone }" >
