...
<div class="input-group has-validation">
	<span class="border border-primary-subtle input-group-text" id="basic-addon1">
	...
	<div class="form-floating is-invalid">
		<input type="text" id="adminCode" name="adminCode" class="border border-primary-subtle form-control" onblur="idDupleCheck(this)">
...
<div class="input-group has-validation">
	...
	<div class="form-floating is-invalid">
	    <input type="password" id="adminPw" name="adminPw" class="border border-primary-subtle form-control" aria-describedby="passwordHelpInline" onblur="passwordCheck()" required>
	...
	<div style="display: flex; justify-content: flex-end;">
		<a href="/admin/loginfail" type="button" class="btn btn-outline-primary">접속코드 / 비밀번호 분실</a>
	</div>
	
	<div class="row mb-3 justify-content-center">
		<button style="margin-top: 40px; margin-left: 100px;width: 500px;" id="loginButton" class="btn btn-outline-primary">로그인</button>
	</div>	
